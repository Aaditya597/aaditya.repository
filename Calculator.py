...
entry = tk.Entry(root, width=20, font=("Arial", 24), borderwidth=2, relief="solid", justify="right", bg="#8f8073", fg="#e9edde")
...
for (text, row, col) in buttons:
    button = tk.Button(root, text=text, width=5, height=2, font=("Arial", 20), bg="#8f8073", fg="#e9edde", relief="raised", borderwidth=2)
    if text == "=":
